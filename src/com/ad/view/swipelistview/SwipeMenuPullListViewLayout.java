 ...
 * 
 */
public class SwipeMenuPullListViewLayout extends FrameLayout {
	...
	private SwipeMenuPullListViewView mMenuView;
	private int mDownX;
	...
	public SwipeMenuPullListViewLayout(View contentView, SwipeMenuPullListViewView menuView) {
	...
	private SwipeMenuPullListViewLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	private SwipeMenuPullListViewLayout(Context context) {
		super(context);
	}
	...
	public SwipeMenuPullListViewView getMenuView() {
		return mMenuView;
	}
