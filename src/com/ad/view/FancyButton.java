 ...
 * @类名称: FancyButton
 * @描述: 自定义的各种样式的button
 * @时间: 2014-12-11 下午6:30:38
 * 
 * <br>在xml文件中， 添加：xmlns:fancy="http://schemas.android.com/apk/res-auto"
...
public class FancyButton extends LinearLayout {
	...
	// private static final ArrayList<String> mDefaultTextFonts = new
	// ArrayList<String>(Arrays.asList("helveticaneue.ttf","robotoregular.ttf","robotothin.ttf"));
	// private static final ArrayList<String> mDefaultIconFonts = new
	// ArrayList<String>(Arrays.asList("fontawesome-webfont.ttf"));
	...
	private void initAttributs(TypedArray attrsArray) {
		...
		mRadius = (int) attrsArray.getDimension(R.styleable.FancyButtonsAttrs_buttonradius, mRadius);
